...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SelectPostImage = (ImageButton) findViewById(R.id.pick_image);
        UpdatePostButton = (Button) findViewById(R.id.post_button);
        PostDescription =(EditText) findViewById(R.id.description_edit);
        ...
        UsersRef.child(current_user_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    //Adding objects to map to be push to Firebase
